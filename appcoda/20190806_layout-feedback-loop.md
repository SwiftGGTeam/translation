...
当你在终端用户的设备上使用 RAM 时，操作系统可以决定为其他进程回收该内存并且终止你的应用程序。我们把这个叫做一个因内存不足导致的运行终止。
可能有各种原因：
* 保留周期
* 竞争条件
* 废弃的线程
...
* 在 Xcode 8 中被引入的 [内存调试器](https://developer.apple.com/videos/play/wwdc2016/410/)，并且该内存调试器替换了一些来自分配和泄漏工具的功能
